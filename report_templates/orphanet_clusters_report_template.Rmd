...
go_df <- read.table("/mnt/scratch/users/bio_267_uma/elenads/neuromuscular_diseases_project/orphanet_analysed_networks/NMDS/clusters_single_funsys_merger.py_0001/clusters_with_70_coherence_systems_go_0.05", sep ="\t", quote="", stringsAsFactors = FALSE, header = FALSE)
