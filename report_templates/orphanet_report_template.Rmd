...
```{r  echo=FALSE, warning=FALSE, message=FALSE, results='asis'}
  metric_table <- data[['orpha_table_metrics_new.txt']]
...
## Step 2: Bipartite network to obtain phenotype-phenotype associations.</div>
  
  
<div align="center">**Table 2:** Bipartite results general summary.  
...
clusters_hpo <- read.table("~/neuromuscular_diseases_project/orphanet_analysed_networks/NMDs/clustering.R_0000/clusters_file_with_names", sep ="\t", quote="", stringsAsFactors = FALSE, header = TRUE)
...
kegg <- read.table("~/neuromuscular_diseases_project/orphanet_analysed_networks/NMDs/clusters_single_funsys_merger.py_0000/clusters_with_70_coherence_systems_kegg_0.05", sep ="\t", quote="", stringsAsFactors = FALSE, header = FALSE)
...
go_df <- read.table("~/neuromuscular_diseases_project/orphanet_analysed_networks/NMDs/clusters_single_funsys_merger.py_0001/clusters_with_70_coherence_systems_go_0.05", sep ="\t", quote="", stringsAsFactors = FALSE, header = FALSE)
...
reactome <- read.table("~/neuromuscular_diseases_project/orphanet_analysed_networks/NMDs/clusters_single_funsys_merger.py_0002/clusters_with_70_coherence_systems_reactome_0.05", sep ="\t", quote="", stringsAsFactors = FALSE, header = FALSE)
...
#clusters_file
clusters_file_cytoscape <- read.table("~/neuromuscular_diseases_project/orphanet_analysed_networks/NMDs/clustering.R_0000/cytoscape_file", sep=" ", header=FALSE, quote="", stringsAsFactors = FALSE)
